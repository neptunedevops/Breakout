...
while run:
    ...
    # paddle collision
    if white_circle_1.colliderect(paddle): y *= -1
    if white_circle_2.colliderect(paddle): y2 *= -1
    if red_circle_1.colliderect(paddle): red_y *= -1
    if red_circle_2.colliderect(paddle): red_y2 *= -1
